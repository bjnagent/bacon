      ...
      <div className="pr-welcome">
        <div className="pr-w">
          ...
          <section className="pr-w-grid" aria-label="What Bacon does">
            <div className="pr-w-card">
              ...
              <div className="pr-w-card-body">
                A ranked set of opportunities where independent signals converge — a real mover,
                a news catalyst, a macro tailwind — including the second-order names the tape
                hasn&apos;t repriced yet.
              </div>
            </div>
            <div className="pr-w-card">
              ...
              <div className="pr-w-card-body">
                ...
                sentiment, risk — streamed live with real web research and live charts.
                Convergence builds conviction.
              </div>
            </div>
            <div className="pr-w-card">
              ...
              <div className="pr-w-card-body">
                Every brief is archived. Come back later and Bacon reviews its own calls —
                played out, developing, faded or invalidated. Real data only; it never
                invents a price.
              </div>
            </div>
          </section>
          ...
          <section className="pr-w-section" aria-label="Install the app on your phone">
            ...
            <div className="pr-w-install-grid">
