...
export async function POST(req: Request) {
  ...
  return textStreamResponse(
    askStream(propertyOutlookPrompt(market.label, statsLine), [{ role: "user", content: `Write the current deep view for ${market.label} — policy, rates, supply, district development & major projects, sentiment, rentals, 12-mo scenarios, 5/10-yr long run, the rent-vs-mortgage carry math, and your verdict.` }], true, 1800, 6),
    async (full, ok) => {
