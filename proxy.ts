...
// person deciding whether to sign up. Module scope: this runs on every request.
...
export async function proxy(request: NextRequest) {
  ...
  // The public pages stay on the session-refresh path rather than the fast path,
  // so their login/cockpit CTA is accurate even when the access token needs a
  // refresh.
